...
export const metadata: Metadata = {
  ...
  description:
    "How the 10% booking amount and 90% balance work, when a refund is given, and how payments are recorded. No payments are taken on this website.",
          ...
          <div className="prose-doc mt-8">
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>Booking</td>
                  <td>{siteConfig.advancePercent}% of the agreed price</td>
                  <td>After the price is confirmed on a call, before work starts</td>
                </tr>
                <tr>
                  <td>Balance</td>
                  <td>{siteConfig.balancePercent}% of the agreed price</td>
                  <td>
                    After the finished document is uploaded and you have seen the
                    preview
                  </td>
                </tr>
                <tr>
                  ...
                  <td>At actuals</td>
                  <td>
                    When the department charges it, shown separately with the
                    receipt
                  </td>
                </tr>
              </tbody>
            ...
            <h2>4. Refund of the booking amount</h2>
            <ul>
              <li>
              ...
              <li>
                ...
                drafting or notary charges already paid).
              </li>
              <li>
            ...
            <p>
              ...
              you as a preview. If the document contains an error caused by us,
              tell us before paying — we correct it first, at no extra charge.
